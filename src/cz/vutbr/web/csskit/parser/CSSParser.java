 ...
 */
 ...
 /*@bgen(jjtree) start */
        ...
        jjtree.openNodeScope(jjtn000);StyleSheet stylesheet = rf.createStyleSheet();
    try {
      stylesheet();
      jj_consume_token(0);
      ...
      try {
        ...
        jj_consume_token(RCURLY);
                  ...
                  jjtc000 = false;
                        ...
                        media.replaceAll( (List<RuleSet>) rules);
 ...
 */
 ...
 /*@bgen(jjtree) selector */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Selector selector = rf.createSelector();
        String value = null;
        Selector.SelectorPart item = null;
        List<Selector.SelectorPart> items = new ArrayList<Selector.SelectorPart>();
    try {
      try {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case IDENT:
        case 68:
          value = element_name();
                                ...
                                selector.setFirstItem(rf.createElement(value));
          label_29:
          while (true) {
            switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
            case LBRACE:

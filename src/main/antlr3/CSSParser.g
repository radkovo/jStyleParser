...
media_expression
 : LPAREN S* MINUS? IDENT S* media_expression_value
    -> ^(DECLARATION MINUS? IDENT media_expression_value)
 ;
 catch [RecognitionException re] {
...
media_expression_value
    : COLON S* terms RPAREN -> terms
    | RPAREN -> MEDIA_QUERY_NO_VALUE
    ;
    catch [RecognitionException re] {
        throw re;
    }
